...
const t = (id: number): Team => ALL_WC2022_TEAMS.find((x) => x.id === id)!;
...
const H2H_HISTORY: Record<string, { matches: HistoricalMatch[]; totalA: number; totalD: number; totalB: number }> = {
  "26-2": {
    ...
    matches: [
      { id: 1, date: "2022-12-18", tournament: "FIFA World Cup", homeTeam: t(26), awayTeam: t(2), score: { home: 3, away: 3 }, winner: "home", stage: "Final" },
  ...
  "2-10": {
    ...
    matches: [
      { id: 20, date: "2022-12-10", tournament: "FIFA World Cup", homeTeam: t(2), awayTeam: t(10), score: { home: 2, away: 1 }, winner: "home", stage: "Quartas de Final" },
  ...
  "26-3": {
    ...
    matches: [
      { id: 30, date: "2022-12-13", tournament: "FIFA World Cup", homeTeam: t(26), awayTeam: t(3), score: { home: 3, away: 0 }, winner: "home", stage: "Semifinal" },
  ...
  "5-27": {
    ...
    matches: [
      { id: 40, date: "2022-12-10", tournament: "FIFA World Cup", homeTeam: t(5), awayTeam: t(27), score: { home: 1, away: 0 }, winner: "home", stage: "Quartas de Final" },
...
function generateH2H(teamA: Team, teamB: Team): H2HData {
  ...
  const recentDates = ["2022-03-25", "2020-11-17", "2019-09-10", "2018-03-23", "2016-11-15"];
...
export async function fetchH2H(teamAId: number, teamBId: number): Promise<H2HData> {
   ...
   *   `https://v3.football.api-sports.io/fixtures/headtohead?h2h=${teamAId}-${teamBId}&season=2022&league=1`,
  ...
  const teamA = ALL_WC2022_TEAMS.find((t) => t.id === teamAId)!;
  const teamB = ALL_WC2022_TEAMS.find((t) => t.id === teamBId)!;

  if (!teamA || !teamB) return generateH2H(ALL_WC2022_TEAMS[0], ALL_WC2022_TEAMS[1]);
